  ...
  function Pristine(form, config, live) {
      ...
      function _getErrorElements(field) {
          ...
          if(errorClassElement) {
            var errorClassElementChild = errorClassElement.querySelector('.' + self.config.classToInput)
          } 
          if (errorClassElementChild) {
            return field.errorElements = [errorClassElementChild, errorTextElement];
          } else {
